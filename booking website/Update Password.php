...
<body>
    ...
    <div class="col-12">
        <div class="card border-primary mb-3 mt-3 d-flex mx-auto" style="max-width: 18rem;">
            <div class="card-header fs-1">Change Password</div>

            <div class="card-body text-primary">
                <div class="row">
                    <form action="php/login_and_signup/passwordchange.php" method="POST">
                        <div class="mb-3">
                            <label for="oldpassword" class="form-label">Current Password</label>
                            <input type="password" class="form-control" id="oldpassword"
                                aria-describedby="passwordHelp" name= "oldpassword">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="newpasswordrepeat" class="form-label">Repeat Password</label>
