...
<body>
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item nav-item li-primary">
            <a class="nav-link active mt-4" href="My Bookings Page.php">My Bookings</a>
        </li>
        <li class="nav-item nav-item li-primary">
    ...
    <div class="card-body">
        <div class="container">
        <form action="php/booking/remove_booking.php" method="POST">
            <table class="table table-striped table align-middle">
                <thead>
                    <tr>
                        ...
                        <th class="col-primary" scope="col">Remove?</th>
                    </tr>
                </thead>
                <tbody>
                   <?php
                        ...
                        $list = 0;
                            ...
                            if(true){
                                include "php/includes/main.php";
                                 ...
                                 echo '<td><button class="btn btn-primary">Remove</button></td>';
                                  $stmt->close();
                                  $conn->close();
